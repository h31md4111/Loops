...
//        System.out.println(commandExecution());
    ...
    public static String dayOfWeek(){
      ...
      int day = scanner.nextInt();
        ...
        switch (day) {
            ...
            break;
            default: result = "Please use number from 1 to 7 for day of a week";
                scanner.close();
        } return result;
    }
    ...
    public static String commandExecution() {
        ...
        switch (command) {
            case "start": result = "Program is started";
            break;
            case "stop": result = "Program is stopped";
            break;
            case "restart": result = "Program is restarted";
            break;
            case "status": result = "Program is showing its status";
            break;
            default : result = "You can use only commands 'start stop restart and status'";
        } return result;
    }
    ...
    public static double calculator() {
        ...
        switch (operator) {
            ...
            break;
            default: throw new IllegalArgumentException("Please use operators ' + - * /");
